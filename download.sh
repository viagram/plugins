...
download_hysteria() {
  ...
  dl_and_chmod arm64-v8a/libhysteria.so "https://github.com/viagram/hysteria/releases/download/$VERSION/hysteria-linux-arm64"
  dl_and_chmod armeabi-v7a/libhysteria.so "https://github.com/viagram/hysteria/releases/download/$VERSION/hysteria-linux-arm"
  dl_and_chmod x86/libhysteria.so "https://github.com/viagram/hysteria/releases/download/$VERSION/hysteria-linux-386"
  dl_and_chmod x86_64/libhysteria.so "https://github.com/viagram/hysteria/releases/download/$VERSION/hysteria-linux-amd64"
}
